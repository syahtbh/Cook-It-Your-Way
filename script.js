function adjustIngredients(recipe) {
    ...
    if (recipe === 'cookies') {
        ...
        defaultIngredients = [
            { name: 'gram of unsalted butter', amount: 7.19 },
            { name: 'gram of brown sugar', amount: 5.63 },
            { name: 'gram of self-raising flour', amount: 13.13 },
            { name: 'gram of eggs', amount: 3.44 },
            { name: 'gram of chocolate chips', amount: 9.37 }
        ];
        ...
        defaultIngredients = [
            ...
            { name: 'gram of meat', amount: 6.67 },
            { name: 'gram of eggs', amount: 73.33 },
            { name: 'gram of pecorino romano cheese', amount: 30 },
            { name: 'gram of black pepper', amount: 0.80 },
            { name: 'gram of salt', amount:  0.90}
        ];
    } else if (recipe === 'cake') {
        ...
        defaultIngredients = [
            ...
            { name: 'gram of baking powder', amount: 2.85 },
            { name: 'gram of coconut milk', amount: 100 },
            { name: 'gram of olive oil', amount:  8.55},
            { name: 'gram of pandan juice', amount:  5.70}
        ];
    }
